    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="/kelurahan/dashboard.php" class="nav-link">
                        <i class="nav-icon fas fa-home" style="color: #fcfcfc;"></i>
                        <p style="color: #fcfcfc;"> Dashboard </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/kelurahan/datawilayah.php" class="nav-link">
                        <i class="nav-icon fas fa-solid fa-map" style="color: #fcfcfc;"></i>
                        <p style="color: #fcfcfc;"> Data Wilayah </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/kelurahan/dataadm.php" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="/kelurahan/hasiladm.php" class="nav-link">
